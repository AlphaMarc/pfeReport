...
I also thank all the member of NICTA QRL who were always ready to help me. It was an amazing adventure both humanely and professionally \\
...
\hline
Performing & Individuals are subservient to the group, roles are flexible and task oriented & Sense of concentration and flow, everything seems easy, high energy, group works without being asked to & This is the time to introduce difficult questions, projective techniques \\
\hline
...
\paragraph{Frequencies} Count the number of occurences of a word

\paragraph{Co-occurence} How different concepts occur in same sentences from the same person. Mappin chi square?

\paragraph{graph-theory driven techniques} Starting from a co-occurrence matrices as input. They provide a bigger picture view of the sample


\subsection{Proposed Themes and Questioning Route for a Focus Group for Regorus}

The table \ref{proposedRoadmap} is a proposition, a draft of a possible execution of a focus group. It describes principal themes and possible questions for each of them with associated intentions behind it. It can be seen as a starting point for a more thorough reflection on conducting a qualitative marketing research in the light of all the previous material.

Themes ?
Motivations (possible incentives)
Decision making process
Influences (Reaction to theory, people of influence)
Features review (anticipated, likes, dislikes)
...
\textbf{\textcolor{myBlue}{Goal 1 Eradicate Extreme Poverty}} & \\
\hline
...
\arrayrulecolor{blue}\hline
\multicolumn{2}{l}{
\textbf{\textcolor{myBlue}{Goal 2 Achieve universal primary education}}} \\
\hline
...
\hline
\multicolumn{2}{l}{%
\textbf{\textcolor{myBlue}{Goal 3 Promote gender equality and empower women}}} \\
\hline
